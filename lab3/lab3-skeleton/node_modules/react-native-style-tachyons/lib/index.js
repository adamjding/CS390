...
exports.options = exports.build = exports.wrap = exports.styles = exports.sizes = undefined;
...
var _absolute = require("./styles/absolute");

var absolute = _interopRequireWildcard(_absolute);

var _tracked = require("./styles/tracked");

var _tracked2 = _interopRequireDefault(_tracked);
...
var hyphensToUnderscores = function hyphensToUnderscores(sourceObj) {
    var translated = {};
...
var NativeTachyons = {
    ...
    build: function build() {
        ...
        var sizes = {};
        var REM_SCALED = [_heights.heights, _heights.minHeights, _heights.maxHeights, _widths.widths, _widths.minWidths, _widths.maxWidths, _spacing2.default, _typeScale2.default, borders.radii, _tracked2.default];
        ...
        REM_SCALED.forEach(function (subSheet) {
            _lodash2.default.forOwn(subSheet, function (styleObj, tachyonsKey) {
                _lodash2.default.forOwn(styleObj, function (val, name) {
                    ...
                    styleSheet[tachyonsKey] = _defineProperty({}, name, val * rem);
        ...
        /* Absolute */
        _lodash2.default.assign(styleSheet, absolute.scaleStyles(options.rem));
        ...
        _lodash2.default.assign(styleSheet, options.customStyles);
        ...
        _lodash2.default.assign(NativeTachyons.options, options);
    }
};
...
var sizes = NativeTachyons.sizes,
    ...
    options = NativeTachyons.options;
exports.sizes = sizes;
