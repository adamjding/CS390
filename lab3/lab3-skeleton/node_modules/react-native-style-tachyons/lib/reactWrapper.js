...
var _lineHeight = require("./styles/lineHeight");
...
function setStyles(props, clsPropName) {
    ...
    var fontSize = _lodash2.default.find(_lodash2.default.keys(_typeScale2.default), function (fSetting) {
        return _lodash2.default.includes(splitted, fSetting);
    });
    ...
    for (var i = 0; i < splitted.length; i++) {
        ...
        if (cls.length > 0) {
            if (_index.styles[cls]) {
                ...
                /* Get font style */
                if (!_lodash2.default.isString(fontSize)) {
                    throw new Error("setting '" + cls + "' needs explicit font-size");
                }

                newProps.style.push({
                    lineHeight: _lineHeight2.default[cls.replace(/_/g, "-")] * _index.styles[fontSize].fontSize
                });
